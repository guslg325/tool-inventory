	...
	$.validettaLanguage = {
		init : function(){
			$.validettaLanguage.messages = {
				...
				minLength	: 'Este campo requiere al menos {count} caracteres.',
				maxChecked	: 'Sólo se puede marcar {count} opciones como máximo.',
				minChecked	: 'Es necesario marcar al menos {count} opciones.',
				maxSelected	: 'Sólo se puede marcar {count} opciones como máximo.',
				minSelected	: 'Es necesario marcar al menos {count} opciones.',
